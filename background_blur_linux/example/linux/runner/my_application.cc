...
static void my_application_activate(GApplication* application) {
  ...
  // Request server-side decorations (SSD): do NOT call gtk_window_set_titlebar().
  // On Wayland, GTK negotiates SSD with the compositor via xdg-decoration when
  // no custom titlebar widget is installed. KWin advertises this protocol, so
  ...
  // Make the window transparent so KWin's blur effect is visible behind it.
